...
class BaseAPI {
  ...
  async get(endpoint, params) {
    await Logger.log(`[req] ▶ get ${JSON.stringify(params || {})} from ${endpoint}:`);
    try {
  ...
  async post(endpoint, params) {
    await Logger.log(`[req] ▶ post ${JSON.stringify(params || {})} to ${endpoint}:`);
    try {
  ...
  async patch(endpoint, params) {
    await Logger.log(`[req] ▶ patch ${JSON.stringify(params || {})} to ${endpoint}:`);
    try {
